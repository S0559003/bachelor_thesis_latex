...
Als praktische Kriterien führt er Eigenschafen wie Kosten, Kompatibilität, Zufverlässigkeit sowie Nutzbarkeit auf. Die Eigenschaft Nutzbarkeit teilt er in die Eigenschaften Nützlichkei (en. Utility) und Gebrauchstauglichkeit (en. Usability) auf.
Unter Utility ist zu verstehen ob die Funktionalitäten eines Systems prinzipiell dazu in der Lage sind, die Aufgabe zu erfüllen wozu sie konzipiert wurden.
...
Nielsen beschreibt in  [Nielsen94] folgende Usablity Engineering Phasen: 
		...
		Kenne deine Nutzer  & Alle zurünftigen Nutzer die mit dem System in Berührung kommen werden. \textbf{ Individual User Characteristics  \textfb{Task Analysis}  \textbf{Functional Analysis} \textbf{The evolution of the User}\\ 
		\hline 
		Analyse bestender Produkte & Beschreibung\\
		\hline 
		...
		\hline 
		Interative Gestaltung & Beschreibung \LaTeX \\
		\hline 
