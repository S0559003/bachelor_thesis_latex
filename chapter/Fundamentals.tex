...
% Vorteil: die Reale Welt kann um die Zeit verzögert dargestellt werden wie das Computersystem für die Positionsbestimmung und das Rendern der virtuellen Objekte benötig. Dadurch werden die Nachteile des Optical-See-Through kompensiert und es kommt zu keinem lag.

% Nachteile: 
%Wenn sich der Nutzer oder reale Objekte im Sichtfeld des Nutzers bewegen kommt werden diese verzögert dargestellt. % Je nach Auflösung kann es zu schlechterer Qalität kommen.
